...
***************************************************************************/
#ifndef __FLOOD_TRACKING_MESSAGE_H__
#define __FLOOD_TRACKING_MESSAGE_H__

namespace wiselib
{
	template<	typename OsModel_P,
				typename Radio_P>
	class FLOOD_TRACKING_MessageType
	{
	public:
		...
		// --------------------------------------------------------------------
		inline FLOOD_TRACKING_MessageType();
		// --------------------------------------------------------------------
	...
	template<typename OsModel_P,
		typename Radio_P>
	FLOOD_TRACKING_MessageType<OsModel_P, Radio_P>::
	FLOOD_TRACKING_MessageType()
	{
		set_msg_id( 0 );
		size_t len = 0;
		write<OsModel, block_data_t, size_t>(buffer + PAYLOAD_POS, len);
