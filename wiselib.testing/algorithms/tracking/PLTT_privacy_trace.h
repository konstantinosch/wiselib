...
#include "algorithms/privacy/privacy_default_values_config.h"
...
namespace wiselib
{
	...
	public:
		...
		typedef PLTT_PrivacyTraceType<Os, Radio, TimesNumber, SecondsNumber, IntensityNumber, Node, NodeID, Debug> self_type;
		// --------------------------------------------------------------------
		inline PLTT_PrivacyTraceType():
			start_time			(0),
			diminish_seconds	(0),
			diminish_amount		(0),
			spread_penalty		(0),
		...
		// --------------------------------------------------------------------
		inline PLTT_PrivacyTraceType( const SecondsNumber& _ds, const IntensityNumber& _da, const IntensityNumber& _sp,	const IntensityNumber& _si, const TimesNumber& _st )
		{
		...
		// --------------------------------------------------------------------
		inline PLTT_PrivacyTraceType( block_data_t* _buff, size_t _offset = 0 )
		{
		...
		{
			_debug.debug( "PLTT_PrivacyTrace : \n" );
