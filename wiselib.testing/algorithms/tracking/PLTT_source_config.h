...
#define CONFIG_PLTT_PASSIVE_H_FLEXIBLE_DB
//#define CONFIG_PLTT_PASSIVE_H_RANDOM_DB
#define CONFIG_PLTT_PASSIVE_H_END_EXP
...
#define DEBUG_PLTT
	...
	//#define DEBUG_TRACK_VIS
	#define DEBUG_PLTT_STATS
	#ifdef DEBUG_PLTT_STATS
		//#define DEBUG_PLTT_STATS_SHAWN
		#define DEBUG_PLTT_STATS_ISENSE
	#endif
