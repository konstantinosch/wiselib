...
#define CONFIG_ATP_H_DISABLE_NEIGHBOR_DISCOVERY
#define CONFIG_ATP_H_END_EXP

#define DEBUG_ATP_H
#ifdef DEBUG_ATP_H
	#define DEBUG_ATP_H_ENABLE
	#define DEBUG_ATP_H_NEIGHBOR_DISCOVERY_ENABLE_TASK
	#define DEBUG_ATP_H_NEIGHBOR_DISCOVERY_DISABLE_TASK
	#define DEBUG_ATP_H_SYNC_NEIGHBORS
#endif
