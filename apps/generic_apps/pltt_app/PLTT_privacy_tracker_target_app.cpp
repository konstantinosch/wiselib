...
#ifdef CONFIG_PLTT_TARGET
#ifdef CONFIG_PLTT_PRIVACY
PLTT_Target target( PLTT_PrivacyTrace( PLTT_TRACE_DIMINISH_SECONDS, PLTT_TRACE_DIMINISH_AMOUNT, PLTT_TRACE_SPREAD_PENALTY, PLTT_TRACE_START_INTENSITY, 0 ), PLTT_TARGET_SPREAD_MILIS, PLTT_TARGET_INIT_SPREAD_MILIS, PLTT_TARGET_TRANSMISSION_POWER );
#else
PLTT_Target target( PLTT_Trace( PLTT_TRACE_DIMINISH_SECONDS, PLTT_TRACE_DIMINISH_AMOUNT, PLTT_TRACE_SPREAD_PENALTY, PLTT_TRACE_START_INTENSITY, 0 ), PLTT_TARGET_SPREAD_MILIS, PLTT_TARGET_INIT_SPREAD_MILIS, PLTT_TARGET_TRANSMISSION_POWER );
#endif
#endif
#ifdef CONFIG_PLTT_TRACKER
