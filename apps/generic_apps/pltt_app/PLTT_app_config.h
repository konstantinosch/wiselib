...
//#define CTI_TESTBED
#define PLTT_MAX_NEIGHBORS_SUPPORTED 15
#define PLTT_MAX_TARGETS_SUPPORTED 1
#define PLTT_MAX_TRACKERS_SUPPORTED 1
#define PLTT_CHANNEL 0
#define PLTT_MAX_PRIVACY_TRACES_SUPPORTED 15
